    ...
    <div class="admin-content">
        ...
        <div class="am-g">
            <div class="am-u-sm-12 am-u-md-12">
                ...
                <form class="am-form" action="{{ route('admin.category.update', $cate->id) }}" method="post">
                    {!! csrf_field() !!}
                    {!! method_field('put') !!}
                        ...
                        <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                            <select data-am-selected="{btnWidth: '100%',  btnStyle: 'secondary', btnSize: 'sm', maxHeight: 360, searchBox: 1}"
                                ...
                                @foreach ($categories as $category)
                                    <option value="{{$category->id}}" @if($category->id == $cate->parent_id) selected @endif>
                                        {{ $category->name }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="am-g am-margin-top">
                        ...
                        <div class="am-u-sm-8 am-u-md-4">
                            <input type="text" class="am-input-sm" name="name" value="{{$cate->name}}">
                        </div>
                    ...
                    <div class="am-g am-margin-top">
                        ...
                        <div class="am-u-sm-8 am-u-md-8 am-u-end col-end">
                            ...
                            <div class="select_thumb">
                                ...
                                <input type="hidden" name="thumb" vaule="{{$cate->thumb}}">
                            </div>

                            <hr data-am-widget="divider" style="" class="am-divider am-divider-dashed" />

                            <div>
                                <img src="{{$cate->thumb}}" id="img_show" style="max-height: 200px;">
                            </div>
                        </div>
                    </div>
