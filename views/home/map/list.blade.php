    ...
    <div id="content">
        <div class="inner">
            ...
            <div class="list-main clearfix">
                <div class="fl">
                    <div class="mianbao">
                        <p>你现在所在的位置：<a href="/">首页</a>&gt;
                            @if(substr(Request::getRequestUri(),6,3) == "add") <a class="add"></a> @elseif(substr(Request::getRequestUri(),6,3) == "inv") <a class="inv"></a> @endif
                        </p>
                    </div>
                    <ul>
                        @foreach ($articles as $article)
                            <li>
                                <input type="hidden" class="address" value="{{$article->address}}">
                                <input type="hidden" class="investment" value="{{$article->investment}}">
                                ...
                                <div class="clearfix">
                                    ...
                                    <div>
                                        <p>项目优势：{{$article->comment}}&nbsp;&nbsp;&nbsp;投资额度：<a>{{$article->investment}}</a></p>
